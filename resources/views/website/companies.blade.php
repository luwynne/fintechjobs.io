...
<section class="title">
    <div class="container">
        <div class="row-fluid">
            <div class="span6">
                <h1>FinTech Companies Directory</h1>
            </div>
            <div class="span6">
...
<section id="about-us" class="container main">
    ...
    <div class="team-block">
        ...
        <div class="company-list-filter">
            <input id="name" type="text" class="form-control width-top-filter" name="search" placeholder="Company name"></input>
        </div>

        <div class="company-list-filter">
            <select id="sector" class="browser-default custom-select width-top-filter">
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
            ...
            function getCompanies(){
                ...
                $.ajax({
                    type : 'get',
                    url : 'http://localhost:8888/fintechjobs.io/companies/get',
                                    ...
                                    '<div class="span8 companies-individual-blocks">'+
                                        '<div class="box bios">'+
                                            '<div class="company-logo-portion">'+
                                                '<a href="http://localhost:8888/fintechjobs.io/company/'+ data[i].id +'/'+ data[i].clean_url_name +'">'+
                                            ...
                                            '<div class="company-info-portion">'+
                                                '<h3 class="company-list-title"><a href="http://localhost:8888/fintechjobs.io/company/'+ data[i].id +'/'+ data[i].clean_url_name +'">'+ data[i].name +'</a></h3>'+
