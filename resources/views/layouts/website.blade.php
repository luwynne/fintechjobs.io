...
<head>
    ...
    {!! Robots::metaTag() !!}
    <title>FinTechjobs.io | <?php echo Route::getCurrentRoute()->getName(); ?></title>
    ...
    <link rel="stylesheet" href="{{asset('css/jobbio.css')}}">
...
<script type="text/javascript">
    ...
    function initActive(){
        var association = $("#association-43");
        association.addClass("active");
    }
