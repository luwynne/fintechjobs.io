      ...
      <section class="modal-body">
        <slot name="body">
            <br>
                    ...
                    <input :disabled="editing == false" v-model="course.name" type="text" name="name" class="form-control">

                     <label for="url">URL</label>
                    <input :disabled="editing == false" v-model="course.url" type="text" name="url" class="form-control">
...
import moment from 'moment';
  ...
  export default {
    ...
    methods:{   
      ...
      update(){
        this.$emit('updateFromChild', this.course);
        this.close();
      }
